      ...
      <div className="flex-1 max-w-xl mx-auto w-full px-4 py-8 space-y-5">
        ...
        {job && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {workshop.phone && (
                <a href={`https://wa.me/60${workshop.phone.replace(/^0/, '')}?text=Salam%2C%20saya%20ingin%20tanya%20tentang%20kenderaan%20${job.plate}`}
              ...
              <button onClick={() => setShowReceipt(true)}
                className={`flex items-center justify-center gap-2 bg-surface-dark hover:bg-surface-deep text-on-dark font-semibold rounded-full py-3.5 transition-colors text-sm ${!workshop.phone ? 'col-span-2' : ''}`}>
